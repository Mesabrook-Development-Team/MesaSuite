...
namespace CompanyStudio
{
    public partial class StudioFormExtender : Component
    {
        ...
        public void ApplyStyle(Control control, ThemeBase theme)
        {
            try
            {
                control.ControlAdded += (s, e) => ApplyStyle(e.Control, theme);
            ...
            {
                // There's no great way to log this. It's also not super important.
                // The user will likely let us know if something is displayed wrong.
            }
        }
    }
}
