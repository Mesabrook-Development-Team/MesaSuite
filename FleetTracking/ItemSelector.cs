...
namespace FleetTracking
{
    public partial class ItemSelector : UserControl
    {
        ...
        private async void LoadInitialData()
        {
            ...
            {
                GetData get = new GetData(DataAccess.APIs.FleetTracking, $"Item/Get/{SelectedItemID}");
        ...
        private async void LoadData()
        {
            ...
            GetData get = new GetData(DataAccess.APIs.FleetTracking, "Item/GetByQuery");
        ...
        private void txtSearch_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            switch(e.KeyCode)
            {
                ...
                case Keys.Enter:
                    ...
                    dgvList_CellClick(dgvList, new DataGridViewCellEventArgs(0, dgvList.SelectedRows[0].Index));
                    e.Handled = true;
                    return;
                case Keys.Down:
                    e.Handled = true;
                    ...
                    if (dgvList.SelectedRows.Count <= 0 || dgvList.SelectedRows[0].Index == dgvList.Rows.Count - 1)
                    {
                    ...
                    dgvList.ClearSelection();
                    dgvList.Rows[index + 1].Selected = true;
                    return;
                case Keys.Up:
                    e.Handled = true;
                    if (dgvList.Rows.Count <= 0) return;

                    if (dgvList.SelectedRows.Count <= 0 || dgvList.SelectedRows[0].Index == 0)
                    {
                        dgvList.ClearSelection();
                    ...
                    int upIndex = dgvList.SelectedRows[0].Index;
                    dgvList.ClearSelection();
                    dgvList.Rows[upIndex - 1].Selected = true;
                    return;
            }
