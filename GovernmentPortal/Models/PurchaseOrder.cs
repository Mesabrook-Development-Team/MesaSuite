...
namespace GovernmentPortal.Models
{
    public class PurchaseOrder
    {
        ...
        //public static Form OpenPurchaseOrderForm<T>(T parent, PurchaseOrder purchaseOrder = null) where T : BaseCompanyStudioContent, ILocationScoped
        //{
        ...
        public static UserControl CreateControlForPurchaseOrder(PurchaseOrder purchaseOrder = null)
        {
            Statuses status = purchaseOrder?.Status ?? Statuses.Draft;
            ...
            {
                case Statuses.Draft:
                    return new Purchasing.PurchaseOrderScreen.Draft.Draft()
                    {
                        PurchaseOrderID = purchaseOrder?.PurchaseOrderID
                    };
            }
