...
namespace GovernmentPortal
{
    public partial class frmEmailEditor : Form
    {
        ...
        private async void frmEmailEditor_Load(object sender, EventArgs e)
        {
            ...
            GetData getTemplate = new GetData(DataAccess.APIs.GovernmentPortal, "EmailTemplate/GetByName");
            getTemplate.AddGovHeader(GovernmentID);
        ...
        private async void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            PostData post = new PostData(DataAccess.APIs.GovernmentPortal, "EmailImplementation/Post", new EmailImplementation()
            {
