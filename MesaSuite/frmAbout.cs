...
namespace MesaSuite
{
    public partial class frmAbout : Form
    {
        ...
        {
            MessageBox.Show("MesaSuite uses text images generated by Textcraft.net.\r\nTow Tickets uses Tow Truck icon from Icons8.\r\nPlayer Heads are powered by MC-Heads.net", "Additional Credits", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
